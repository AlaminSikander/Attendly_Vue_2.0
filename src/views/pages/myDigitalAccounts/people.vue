...
<template>
    <div>
        <router-link :to="{ name: 'newClient' }" class="text-light">
            <Button label="Create New | +" rounded class="mb-2 mr-2" />
        </router-link>
        <router-link :to="{ name: 'newClient' }" class="text-light">
            <Button label="Sync MDA | ⟳" rounded class="mb-2 mr-2" />
        </router-link>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <DataTable :value="customer1" :paginator="true" :rows="10" dataKey="id" :rowHover="true"
                    ...
                    <Column field="peopleId" header="People Id(MDA)" :sortable="true" style="min-width: 12rem">
                        <template #body="{ data }">
                            {{ data.id }}
                        </template>
